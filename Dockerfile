...
RUN powershell -Command (New-Object System.Net.WebClient).DownloadFile('https://github.com/msys2/msys2-installer/releases/download/2022-01-28/msys2-x86_64-20220128.exe', 'c:\\msys2-x86_64-20220128.exe'); \
   .\msys2-x86_64-20220128.exe in --confirm-command --accept-messages --root C:\msys2 ; \
   [Environment]::SetEnvironmentVariable('PATH', $env:PATH + ';C:\msys2', [EnvironmentVariableTarget]::Machine); \
   Remove-Item 'C:\msys2-x86_64-20220128.exe'
