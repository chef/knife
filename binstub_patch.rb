...
_knife_vendor = File.expand_path(File.join(__dir__, "..", "vendor"))
...
_chef_gem_dir = File.join(Dir.home, ".chef", "ruby", RbConfig::CONFIG["ruby_version"], "gems")
_existing_paths = ENV["GEM_PATH"]&.split(File::PATH_SEPARATOR) || []
ENV["GEM_PATH"] = ([_knife_vendor, Gem.user_dir, _chef_gem_dir] + _existing_paths).uniq.join(File::PATH_SEPARATOR)
